...
namespace AKNet.Common
{
    ...
    /// 适用于 频繁的修改数组
    /// </summary>
    internal class AkCircularBufferGeneric<T>
	{
        ...
        public AkCircularBufferGeneric(int initCapacity = 1024 * 8, int nMaxCapacity = 0)
		{
			nBeginReadIndex = 0;
			nBeginWriteIndex = 0;
			dataLength = 0;
		...
		public int WriteFrom (AkCircularBufferGeneric<T> writeBuffer, int count)
		{
			if (writeBuffer.Length < count) {
				count = writeBuffer.Length;
			}
