...
//        public BlockingCollection<SSocketAsyncEventArgs> EventQ = new BlockingCollection<SSocketAsyncEventArgs>();
...
//                Worker.EventQ.Add(Worker.ShutdownSqe);
...
//            {
//                Worker.EventQ.Add(Worker.WakeSqe);
//            }
//        }
...
//                if (Worker.EventQ.TryTake(out mArgs, (int)Worker.State.WaitTime))
//                {
//                    CqeCount++;
//                    Cqes.Add(mArgs);
//                }
...
//            if (QueueEvent)
//            {
//                Worker.EventQ.Add(Worker.UpdatePollSqe);
//            }
//        }
