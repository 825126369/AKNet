...
namespace AKNet.Socket
{
    public partial class SocketAsyncEventArgs : EventArgs, IDisposable
    {
        ...
        internal void StartOperationAccept()
        {
            ...
            _acceptAddressBufferCount = 2 * (AKNetSocket.GetAddressSize(_currentSocket!._rightEndPoint!) + 16);
        ...
        internal bool DnsConnectAsync(DnsEndPoint endPoint, SocketType socketType, ProtocolType protocolType)
        {
            ...
            {
                AKNetSocket? tempSocketIPv4 = null, tempSocketIPv6 = null;
                ...
                try
                {
                    ...
                    {
                        AKNetSocket? attemptSocket = null;
                        ...
                        else
                        {
                            ...
                            {
                                attemptSocket = tempSocketIPv6 ??= (AKNetSocket.OSSupportsIPv6 ? new AKNetSocket(AddressFamily.InterNetworkV6, socketType, protocolType) : null);
                            ...
                            {
                                attemptSocket = tempSocketIPv4 ??= (AKNetSocket.OSSupportsIPv4 ? new AKNetSocket(AddressFamily.InterNetwork, socketType, protocolType) : null);
                            }
                        ...
                        {
                            using (cancellationToken.UnsafeRegister(s => AKNetSocket.CancelConnectAsync((SocketAsyncEventArgs)s!), internalArgs))
                            {
