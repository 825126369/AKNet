...
namespace AKNet.MSQuic.Server
{
    internal class QuicServer : QuicServerInterface
    {
        ...
        public void addNetListenFunc(ushort id, Action<QuicClientPeerBase, QuicNetPackage> func)
        {
            mPackageManager.addNetListenFunc(id, func);
        }

        public void removeNetListenFunc(ushort id, Action<QuicClientPeerBase, QuicNetPackage> func)
        {
