...
namespace AKNet.Platform.Socket
{
    public partial class SocketAsyncEventArgs : EventArgs, IDisposable
    {
        ...
        internal unsafe SocketError DoOperationAccept(AKNetSocket _ /*socket*/, SafeSocketHandle handle, SafeSocketHandle? acceptHandle, CancellationToken cancellationToken)
        {
        ...
        internal unsafe SocketError DoOperationConnectEx(AKNetSocket _ /*socket*/, SafeSocketHandle handle)
        {
        ...
        internal SocketError DoOperationDisconnect(AKNetSocket socket, SafeSocketHandle handle, CancellationToken _ /*cancellationToken*/)
        {
        ...
        internal unsafe SocketError DoOperationReceiveMessageFrom(AKNetSocket socket, SafeSocketHandle handle, CancellationToken cancellationToken)
        {
            ...
            bool isIPv4, isIPv6;
            AKNetSocket.GetIPProtocolInformation(socket.AddressFamily, _socketAddress!, out isIPv4, out isIPv6);
        ...
        internal SocketError DoOperationSendPackets(AKNetSocket socket, SafeSocketHandle _1 /*handle*/, CancellationToken cancellationToken)
        {
        ...
        private SocketError FinishOperationAccept(SocketAddress remoteSocketAddress)
        {
            ...
            AKNetSocket acceptedSocket = _currentSocket!.CreateAcceptSocket(
