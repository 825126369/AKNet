...
namespace AKNet.Platform
{
    ...
    internal static unsafe partial class OSPlatformFunc
    {
        public const bool bUseRio = false;
        ...
        static int SocketCreateUdp()
        {
            ...
            SafeHandle Socket = Interop.Winsock.WSASocketW(AF_INET6, SOCK_DGRAM, IPPROTO_UDP, IntPtr.Zero, 0, SocketFlags);
            if(Socket == null)
            {
                goto Error;
            }
            ...
            bool Option = false;
            Interop.Winsock.setsockopt(Socket, IPPROTO_IPV6, IPV6_V6ONLY, (byte*)&Option, sizeof(bool));
