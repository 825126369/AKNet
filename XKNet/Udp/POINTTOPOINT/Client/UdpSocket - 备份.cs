...
//                        int nSendLength = mSocket.SendToAsync(mPackage.buffer, 0, mPackage.Length, SocketFlags.None, remoteEndPoint);
//                        NetLog.Assert(nSendLength == mPackage.Length, $"{nSendLength} | {mPackage.Length}");
//                    }
